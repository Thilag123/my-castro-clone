(self.webpackChunkcastro = self.webpackChunkcastro || []).push([[882], {
    77340: function(t, e, n) {
        "use strict";
        n.r(e),
        n.d(e, {
            CountUp: function() {
          ...
          , i = function() {
            ...
            return t.prototype.handleScroll = function(t) {
                if (t && window && !t.once) {
                    ...
                    t.options.scrollSpyOnce && (t.once = !0)) : window.scrollY > r && !t.paused && t.reset()
                }
            }
            ,
    ...
    40835: function(t, e, n) {
          ...
          , b = function(t) {
            var e = r.useMemo((function() {
              ...
              , C = h((function() {
                ...
                s && s > 0 ? w.current = setTimeout(t, 1e3 * s) : t(),
                null === c || void 0 === c || c({
                    pauseResume: S,
                    reset: T,
                    update: k
            ...
            return r.useEffect((function() {
                V.current ? a && R(!0) : (V.current = !0,
                R())
            }
            ), [a, V, R, s, t.start, t.suffix, t.prefix, t.duration, t.separator, t.decimals, t.decimal, t.formattingFn]),
        ...
        e.ZP = function(t) {
            ...
            ), [E, n, t.start, t.suffix, t.prefix, t.duration, t.separator, t.decimals, t.decimal, t.className, t.formattingFn]),
            r.useEffect((function() {
                d.current = !0
            }
            ), []),
            "function" === typeof o ? o({
                ...
                ref: p,
                style: s
            }, i), t.start ? O().formattingFn(t.start) : "")
        }
    },
    46572: function(t, e, n) {
        var r;
        r = function(t, e) {
            return function(t) {
                var e = {};
                    ...
                    function e(t) {
                        ...
                        b(d(n), "check", (function() {
                            ...
                            if (!r)
                                return n.state;
                            if (t = function(t) {
                                return void 0 === t.width && (t.width = t.right - t.left),
                            ...
                            if (s && n.props.partialVisibility) {
                                var u = t.top <= e.bottom && t.bottom >= e.top && t.left <= e.right && t.right >= e.left;
                                "string" === typeof n.props.partialVisibility && (u = a[n.props.partialVisibility]),
                                l = n.props.minTopValue ? u && t.top <= e.bottom - n.props.minTopValue : u
                            }
                            "string" === typeof o.direction && "number" === typeof o.value && (console.warn("[notice] offset.direction and offset.value have been deprecated. They still work for now, but will be removed in next major version. Please upgrade to the new syntax: { %s: %d }", o.direction, o.value),
                            l = c()(o, t, e));
                            var p = n.state;
                            return n.state.isVisible !== l && (p = {
                                isVisible: l,
                                visibilityRect: a
                            },
                            n.setState(p),
        ...
        ,
        t.exports = r(n(72791), n(54164))
    }
}]);
//# sourceMappingURL=882.9d9802b2.chunk.js.map
